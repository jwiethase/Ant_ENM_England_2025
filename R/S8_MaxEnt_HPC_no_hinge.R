...
# 
# Script Description:  
# Fit Maxent models with parameter tuning on HPC. Don't allow hinge features. 
...
dir.create("Ant_ENM/model_out_V2/no_hinge")
dir.create("Ant_ENM/figures_V2/no_hinge")

# if(exists(paste0("Ant_ENM/model_out_soilTemp/", gsub(" ", "_", species_choice), '_thin', thin_dist, '_All_30m_seed_', seed, '_', n_background, ".RDS"))){
...
saveRDS(best_model, paste0("Ant_ENM/model_out_V2/no_hinge/", gsub(" ", "_", species_choice), '_thin', thin_dist, '_All_30m_seed_', seed, '_', n_background, ".RDS"))
saveRDS(e.mx, paste0("Ant_ENM/model_out_V2/no_hinge/ENMeval_", gsub(" ", "_", species_choice), '_thin', thin_dist, '_All_30m_seed_', seed, '_', n_background, ".RDS"))
...
write.csv(var_importance, paste0("Ant_ENM/model_out_V2/no_hinge/PermVarImp_", gsub(" ", "_", species_choice), '_thin', thin_dist, '_All_30m_seed_', seed, '_', n_background, ".csv"))
...
pdf(paste0("Ant_ENM/figures_V2/no_hinge/effectsPartial_", gsub(" ", "_", species_choice), '_thin', thin_dist, '_All_30m_seed_', seed, '_', n_background, ".pdf"), width = 14, height = 14)
par(mfrow = c(1, 1))
plot_maxent_effects(best_model, rename_tab = labels, type = 'partial')
dev.off()

pdf(paste0("Ant_ENM/figures_V2/no_hinge/effectsMarginal_", gsub(" ", "_", species_choice), '_thin', thin_dist, '_All_30m_seed_', seed, '_', n_background, ".pdf"), width = 14, height = 14)
par(mfrow = c(1, 1))
...
pdf(paste0('Ant_ENM/figures_V2/no_hinge/PredsFine_', gsub(" ", "_", species_choice), '_thin', thin_dist, '_seed', seed, '_', n_background, '.pdf'),
    width = 8, height = 8)
...
pdf(paste0('Ant_ENM/figures_V2/no_hinge/FE_examples_', gsub(' ', '_', species_choice), '_thin', thin_dist, '_seed', seed, '_', n_background, '.pdf'),
    width = 8, height = 6)
